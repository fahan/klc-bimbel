  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Pencatatan Pengeluaran</h2>
          <p className="text-sm text-gray-500 mt-0.5">Operasional dan pembelian aset per cabang</p>
        </div>
        <button
          onClick={openCreate}
